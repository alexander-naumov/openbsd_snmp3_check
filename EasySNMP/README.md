...
This script can be used to check OpenBSD systems via SNMPv3
by using monitoring systems like Nagios/Icinga/Centreon and
others. It uses EasySNMP python library.

This version is not supported anymore.

## Features
- [x] memory and swap usage
- [x] file system space usage
- [x] CPU load average
- [x] shows detailed information about all avaliable file systems
- [x] statistics about configured NICs
- [x] system information about OS
